"""Remove only DRC-identified dangling AMP_SW_POS copper in the C9 trial."""
...
(D/'reports/c9-spur-removal.json').write_text(json.dumps({'removed_uuids':removed,'drc_findings':len(d['violations']),'unconnected_items':len(d['unconnected_items'])},indent=2))
