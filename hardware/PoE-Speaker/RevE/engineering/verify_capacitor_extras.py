...
codes=['C0805C106K4RACTU','C0805C226M8RACTU','C1210C476M4RACTU','C1210C104J1GACTU','C1206C104J5GACTU','C1210C104J5GACTU','C0805C105K1RAC7800','C0805C104K1RACTU']
...
(out/'verification-extra.json').write_text(json.dumps(rows,indent=2))
