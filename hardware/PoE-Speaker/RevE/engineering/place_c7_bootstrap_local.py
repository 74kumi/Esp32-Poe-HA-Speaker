"""Trial a local C7 connection at the amplifier BSNR/OUTNR pins."""
...
for t in ts:
 if t.GetNetname()=='AMP_BSNL':b.Remove(t)
f=fs['C7'];f.SetPosition(p.VECTOR2I(p.FromMM(214.5),p.FromMM(115)));f.SetOrientation(p.EDA_ANGLE(90,p.DEGREES_T));f.Reference().SetPosition(p.VECTOR2I(p.FromMM(214.5),p.FromMM(117.4)))
