"""Remove only DRC-identified dangling AMP_SW_NEG copper in the C12 trial."""
...
(D/'reports/c12-spur-removal.json').write_text(json.dumps({'removed_uuids':removed,'drc_findings':len(d['violations']),'unconnected_items':len(d['unconnected_items'])},indent=2))
