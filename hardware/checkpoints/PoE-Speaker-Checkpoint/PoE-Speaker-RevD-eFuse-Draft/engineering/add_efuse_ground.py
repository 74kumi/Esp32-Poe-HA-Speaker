...
D=Path('KiCad-RevD');b=p.LoadBoard(str(D/'PoE-Speaker-RevD.kicad_pcb'))
...
b.Add(z);f=p.ZONE_FILLER(b);f.Fill(b.Zones());p.SaveBoard(str(D/'PoE-Speaker-RevD.kicad_pcb'),b)
