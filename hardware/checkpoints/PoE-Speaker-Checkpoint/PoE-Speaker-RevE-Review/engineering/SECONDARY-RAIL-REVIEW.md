> Historical review. Superseded items: U7 FSW is now tied to 3V3; saved ERC is zero following source review/annotations. Remaining regulator-loop/stability checks below are still open. See ORDER-RELEASE-REVIEW.md for current release status.
