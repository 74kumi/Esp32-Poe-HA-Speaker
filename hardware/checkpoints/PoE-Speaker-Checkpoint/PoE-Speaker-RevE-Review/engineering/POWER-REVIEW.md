...
## Bench protection proposal — 2026-09-12

See `BENCH-INPUT-PROTECTION.md` and `bench-ovp-calculation.json`: TPS26630 candidate, 25.2 V nominal trip, 24.619–25.783 V static corner range. This is a calculated proposal, not an implemented or qualified circuit. The 0.217 V upper margin needs temperature and dynamic review before implementation.
