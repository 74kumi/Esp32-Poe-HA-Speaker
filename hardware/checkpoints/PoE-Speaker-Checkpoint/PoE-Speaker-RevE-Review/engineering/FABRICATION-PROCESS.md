...
Remaining release work includes power/ground thermal copper, switching loops, Ethernet return paths and impedance, fault/startup review, exact order codes, remaining imported-symbol electrical review (saved ERC now zero), and mechanical fit. A clean DRC with this profile is a geometry milestone only.
