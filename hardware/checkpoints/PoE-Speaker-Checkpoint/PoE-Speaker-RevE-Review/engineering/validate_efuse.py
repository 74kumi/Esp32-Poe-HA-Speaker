...
D=Path('KiCad-RevD');m=json.loads(Path('engineering/revision-d-design.json').read_text());tree=X.parse(D/'reports/schematic-netlist.xml');actual={}
...
b=pcb.LoadBoard(str(D/'PoE-Speaker-RevD.kicad_pcb'))
